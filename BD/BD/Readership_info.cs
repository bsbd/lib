...
namespace BD2
{
    public partial class Readership_info : Form
    {
        ...
        DataTable GetComments()
        {
            ...
            {
                Program.conn.Open();
                NpgsqlCommand command = new NpgsqlCommand("SELECT * FROM readership_info ORDER BY ticket_number LIMIT " + y + " offset " + j, Program.conn);
                NpgsqlCommand command1 = new NpgsqlCommand("SELECT COUNT(*) FROM readership_info", Program.conn);
        ...
        void create_comb()
        {
            ...
            {
                Program.conn.Open();
                NpgsqlCommand command2 = new NpgsqlCommand("SELECT * FROM readership", Program.conn);
                ...
                while (dr2.Read())
                {
                    string ticket_number = dr2.GetValue(0).ToString();
                    comboBox2.Items.Add(ticket_number);
                }
            }
            catch (Exception ex)
            {
            ...
            comboBox2.Items.Add("");
            comboBox3.Items.Add("");
            comboBox3.Items.Remove("ticket_number");
            Program.conn.Close();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                Program.conn.Open();
                string sqlQuery = "INSERT INTO readership_info (ticket_number,name,surname,birth_day,gender,phone) VALUES (@add1, @add2, @add3, @add4, @add5, @add6)";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                Program.conn.Open();
                string sqlQuery = "DELETE FROM readership_info WHERE ticket_number = @select";
                NpgsqlCommand command = new NpgsqlCommand(sqlQuery, Program.conn);
                try
                {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {             
                    string sqlQuery = "UPDATE readership_info SET name = @select1 WHERE ticket_number = @select2";
                    NpgsqlCommand command = new NpgsqlCommand(sqlQuery, Program.conn);
                    try
                    {
                ...
                {
                    string sqlQuery = "UPDATE readership_info SET surname = @select1 WHERE ticket_number = @select2";
                    NpgsqlCommand command = new NpgsqlCommand(sqlQuery, Program.conn);
                    try
                    {
                ...
                {
                    string sqlQuery = "UPDATE readership_info SET birth_day = @select1 WHERE ticket_number = @select2";
                    NpgsqlCommand command = new NpgsqlCommand(sqlQuery, Program.conn);
                    try
                    {
                ...
                {
                    string sqlQuery = "UPDATE readership_info SET gender = @select1 WHERE ticket_number = @select2";
                    NpgsqlCommand command = new NpgsqlCommand(sqlQuery, Program.conn);
                    try
                    {
                ...
                {
                    string sqlQuery = "UPDATE readership_info SET phone = @select1 WHERE ticket_number = @select2";
                    NpgsqlCommand command = new NpgsqlCommand(sqlQuery, Program.conn);
                    try
                    {
